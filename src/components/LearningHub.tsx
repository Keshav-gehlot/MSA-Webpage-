        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {categories.map((item, i) => (
            <motion.div
              ...
              className={cn(
                "group relative p-6 md:p-8 rounded-3xl bg-surface-1 border border-white/10 hover:border-white/20 hover:-translate-y-1 transition-all duration-300 flex flex-col overflow-hidden",
                item.colSpan
              )}
            >
